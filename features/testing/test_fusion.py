...
def logger(log_str):
    ...
    with open('data/outputs/data/outputs/exps/test_fusonnet/2021-12-16 22-37/log.txt','a',encoding='utf-8') as file:
        file.write(log_str)
...
def test_fusonnet():
    ...
    # weightPath = "data/outputs/exps/train_fusonnet/2021-12-15 00-10/epoch-50-0.14198220521211624-Weights.pth" # 141
    # weightPath = "data/outputs/exps/train_fusonnet/2021-12-15 05-00/epoch-10-0.11302029200706737-Weights.pth" # 157g
    # weightPath = "data/outputs/exps/train_fusonnet/2021-12-16 00-06/epoch-8-0.14731012320518494-Weights.pth" # 147g
    # weightPath = "data/outputs/exps/train_fusonnet/2021-12-16 05-12/epoch-134-0.1415516132513682-Weights.pth" # 147g
...
def combineBPandGBDT():
    BP_train_path = 'data/outputs/exps/test_fusonnet/2021-12-16 22-37/train_weight_pr.csv'
    BP_test_path = 'data/outputs/exps/test_fusonnet/2021-12-16 22-37/val_weight_pr.csv'
    GBDT_train_path = 'GBDT/data/outputs/exps/lgbm_data_20210206-1198/2021-12-16_21-58/train_predict.csv'
    GBDT_test_path = 'GBDT/data/outputs/exps/lgbm_data_20210206-1198/2021-12-16_21-58/test_predict.csv'

    # GBDT_train_path = 'GBDT/data/outputs/exps/xgb_data_20210206-1198/2021-12-16_22-53/train_predict.csv'
    # GBDT_test_path = 'GBDT/data/outputs/exps/xgb_data_20210206-1198/2021-12-16_22-53/test_predict.csv'
    ...
    GBDT_test_df.to_csv('data/outputs/exps/test_fusonnet/2021-12-16 22-37/combined_result.csv')
