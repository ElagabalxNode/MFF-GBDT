...
from training_workspace.utils.transforms import ToTensor, RandomHorizontalFlip, Compose
...
def gotoMain():
    ...
    # dataPath = 'data/105'
    dataPath = 'training_workspace/data/raw/coco_sets/mixData'
    from datetime import datetime
    today = datetime.now().strftime("%m%d")
    saveModelName = f"training_workspace/data/models/segmentation/maskrcnn/model-{today}-"
    trainValRate = 0.2
