...
# df_test = pd.read_csv('data/processed/csvData/20210206-200-1198-manuals/20210206-1198-test-0.2.csv')# manual features
df_test = pd.read_csv('data/processed/csvData/20210206-200-1198-manuals/20210206-1198-normal-test-0.2.csv') # normalized manual features
...
# model_weight = 'data/outputs/exps/lgbm_data_20210206-1198/2021-12-16_21-11/result.pkl' # no normal
model_weight = 'data/outputs/exps/lgbm_data_20210206-1198/2025-11-20_15-22/result.pkl' # with normal

# model_weight = 'data/outputs/exps/xgb_data_20210206-1198/2021-12-16_21-18/xgb.pkl' # no normal
# model_weight = 'data/outputs/exps/xgb_data_20210206-1198/2022-09-16_15-36/xgb.pkl' # with normal
