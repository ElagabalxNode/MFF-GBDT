...
def parse_args():
    ...
    # Data and Model
    parser.add_argument("--data_yaml", type=str, default="training_workspace/data/processed/yolo_dataset/dataset.yaml", help="Path to dataset.yaml")
    ...
    parser.add_argument("--save_dir", type=str, default="training_workspace/data/models/segmentation/yolo", help="Directory to save final weights")
