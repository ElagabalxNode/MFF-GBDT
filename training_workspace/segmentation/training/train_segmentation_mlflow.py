...
from training_workspace.segmentation.datasets.Penn_Fudan_dataset import PennFudanDataset
from training_workspace.segmentation.models.Mask_rcnn_Model import get_model_instance_segmentation
from training_workspace.utils.engine import train_one_epoch, evaluate
from training_workspace.utils import general as utils
...
def parse_args():
    ...
    # Data
    parser.add_argument("--data_path", type=str, default="training_workspace/data/raw/coco_sets/mixData", help="Path to dataset")
    ...
    parser.add_argument("--weights_save_dir", type=str, default="training_workspace/data/models/segmentation/maskrcnn", help="Directory to save weights")
